...
{
	$dataId = $_POST['dataId'];
	$des_sql = mysql_query("SELECT * FROM news WHERE id = ".$dataId."");
								...
								<div class="card-header" data-background-color="purple">
									<div class="nav-tabs-navigation">
										<div class="nav-tabs-wrapper">
											<span class="nav-tabs-title">სიახლის რედაქტირება:</span>
								...
								<form enctype="multipart/form-data"  id="submit-form">
									...
									<div class="card-content">
													...
													<div class="tab-pane active" id="profile">
						                                    <div class="row">
						                                        ...
						                                        <div class="col-md-12">
																	<div class="form-group label-floating">
																		<label class="control-label">სიახლის სახელი</label>
																		<input type="text" class="form-control" name="news_title_geo" value="<?php echo $des_row["news_title_geo"] ?>">
																	</div>
						                                        </div>
						                                        ...
						                                        <div class="col-md-12">
																	<div class="form-group label-floating">
																		...
																		<input type="text" class="form-control"  name="news_description_short_geo" value="<?php echo $des_row["news_description_short_geo"] ?>">
																	</div>
						                                        </div>
                                                            ...
                                                            <div class="col-md-12">
                                                                <div class="form-group label-floating">
                                                                    ...
                                                                    <textarea class="form-control textareaa" name="news_description_long_geo"> <?php echo $des_row["news_description_long_geo"]; ?></textarea>
                                                                </div>
                                                            </div>
										...
										<!--english-->
													<div class="tab-pane" id="messages">
															<div class="row">
						                                        ...
						                                        <div class="col-md-12">
																	<div class="form-group label-floating">
																		...
																		<input type="text" class="form-control"  name="news_title_eng" value="<?php echo $des_row["news_title_eng"] ?>">
																	</div>
						                                        </div>
						                                        ...
						                                        <div class="col-md-12">
																	<div class="form-group label-floating">
																		...
																		<input type="text" class="form-control" name="news_description_short_eng" value="<?php echo $des_row["news_description_short_eng"]; ?>">
																	</div>
						                                        </div>
                                                            ...
                                                            <div class="col-md-12">
                                                                <div class="form-group label-floating">
                                                                    ...
                                                                    <div style="clear: both; height: 40px;"></div>
                                                                    <textarea class="form-control textareaa" name="news_description_long_eng"> <?php echo $des_row["news_description_long_eng"]; ?></textarea>
                                                                </div>
                                                            </div>
                                                    ...
                                                    <input type="hidden" name="newsId" value="<?php echo $des_row["id"] ?>">
                                                    <input type="hidden" name="newsPhoto" value="<?php echo $des_row["photo"] ?>">
...
<script type="text/javascript">
		...
		$(document).ready(function() {
            $("#images-input").fileinput({
				...
				<?php
					echo "\"<img src='../upload/news/" . $des_row["photo"] ."' class='file-preview-image' style='width:150px;'>\","
				?>
				],
