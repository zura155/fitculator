	                        ...
	                        <div class="card" style="min-height:457px;">
	                            ...
	                            <div class="card-content table-responsive">
	                                <table class="table">
										...
										$stmt = $db->query('SELECT count(id) FROM product');
										...
										$data = $db->query('SELECT * FROM product ORDER BY id DESC '.$pages->get_limit());
                                        ...
                                        ?>
	                                        ...
	                                        <tr>
	                                        	<td><a href="<?php echo $news_row["id"]; ?>"><?php echo $news_row["name_geo"]; ?></a></td>
	                                        	<td><?php echo $news_row["price"]; ?></td>
	                                        	<td><?php if($news_row["status"] == 1){echo "არის"; } else { echo  "არ არის";} ?></td>
					...
					<div class="col-md-4">
						<div class="card">
								...
								<div class="card-footer">
									<div class="stats"><a href="category_view.php" class="redi">კატეგორიების რაოდენობა <h3 class="title right">3</h3> </a></div>
								</div>
						</div>
					</div>
    ...
    <script>
		$(document).ready(function() {
			...
			$("#confirm-submit .btn-success.success").click(function(){
				...
				$.post('', {table_name: 'product', data_id: currentId});
				location.reload();	
			});
