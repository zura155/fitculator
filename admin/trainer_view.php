			...
			<nav class="navbar navbar-transparent navbar-absolute">
				<div class="container-fluid">
					...
					<div class="navbar-header">
						...
						<a class="navbar-brand" href="#">ტრენერები</a>
					</div>
	                        ...
	                        <div class="card">
	                            <div class="card-header" data-background-color="purple">
	                                <a href="add_trainer.php">
	                                	<i class="material-icons" style="float: right; font-size: 50px; padding-right: 60px;">add_box</i>
	                                </a>
	                                <h4 class="title">ტრენერები</h4>
	                                <p class="category">ჩვენი ყველა ტრენერი</p>
	                            </div>
	                            <div class="card-content table-responsive">
	                                <table class="table">
	                                    <thead class="text-primary">
	                                    	<th width="120">სურათი</th>
	                                    	<th>ტრენერის სახელი</th>
                                            <th  width="90">FB / IN</th>
	                                    </thead>
	                                    <tbody>
                                        ...
                                        $stmt = $db->query('SELECT count(id) FROM trainers');
                                        ...
                                        $data = $db->query('SELECT * FROM trainers ORDER BY id DESC '.$pages->get_limit());
                                        ...
                                        ?>
	                                        ...
	                                        <tr>
	                                        	<td><img src="../upload/trainers/<?php echo $news_row["photo"]; ?>" style="width: 70px; min-height:50px; max-height:50px;"></td>
	                                        	<td><?php echo $news_row["name_geo"]; ?></td>
	                                        	<td>
                                                	<a href="" style="color:#2D50F1"><i class="fa fa-facebook" aria-hidden="true"></i></a> - 
                                                    <a href="" style="color:#2D50F1"><i class="fa fa-linkedin" aria-hidden="true"></i></a>
                                                </td>


												<td class="td-actions text-right">
													<form  class="editDel" method="post" action="edit_trainer.php">
					...
					<div class="col-md-4">
							<div class="card">
								...
								<div class="card-footer">
									<div class="stats"><a href="training_view.php">ტრენერების რაოდენობა <h3 class="title right">3</h3> </a></div>
								</div>
							</div>
	 ...
	 <script>
		$(document).ready(function() {
			...
			$("#confirm-submit .btn-success.success").click(function(){
				...
				$.post('', {table_name: 'trainers', data_id: currentId});
				location.reload();	
			});
