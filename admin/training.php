				...
				<div class="container-fluid">
					...
					<div class="col-md-6">
							<div class="card">
								...
								<div class="card-footer">
									<div class="stats"><a href="trainer_view.php">ტრენერების რაოდენობა <h3 class="title right"><?php countResult("trainers"); ?></h3> </a></div>
								</div>
							</div>
						</div>
					...
					<div class="col-md-6">
							<div class="card">
								...
								<div class="card-footer">
									<div class="stats"><a href="training_view.php">ტრენინგების რაოდენობა <h3 class="title right"><?php countResult("training"); ?></h3> </a></div>
								</div>
							</div>
						</div>
