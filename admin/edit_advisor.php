...
if(isset($_POST['data_id']))
{
	...
	$des_sql = mysql_query("SELECT * FROM advisor WHERE id = ".$dataId."");
...
<body>
	...
	<div class="wrapper">
	    ...
	    <div class="main-panel">
			...
			$designers_sql= mysql_query("SELECT * FROM `advisor` WHERE `id` = ".$designerId."");
								...
								<div class="card-header" data-background-color="purple">
									<div class="nav-tabs-navigation">
										<div class="nav-tabs-wrapper">
											<span class="nav-tabs-title">მრჩეველის რედაქტირება:</span>
						                                    ...
						                                    <div class="row">
						                                        ...
						                                        <div class="col-md-12">
																	<div class="form-group label-floating">
																		<label class="control-label">მრჩეველი სახელი</label>
...
<script type="text/javascript">
		...
		$(document).ready(function() {
            $("#images-input").fileinput({
				...
				<?php
					echo "\"<img src='../upload/advisor/" . $designers_row["photo"] ."' class='file-preview-image' style='width:150px;'>\","
				?>
				],
