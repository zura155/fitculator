								...
								<div class="card-header" data-background-color="purple">
									<div class="nav-tabs-navigation">
										<div class="nav-tabs-wrapper">
											<span class="nav-tabs-title">კატეგორიის დამატება</span>
								...
								<form enctype="multipart/form-data"  id="submit-form">
									...
									<div class="card-content">
						                                    ...
						                                    <div class="row">
						                                        ...
						                                        <div class="col-md-12">
																	<div class="form-group label-floating">
																		...
																		<input type="text" name="categoryNameGeo" class="form-control" >
																	</div>
						                                        </div>
						                                        ...
						                                        <div class="col-md-12">
																	<div class="form-group label-floating">
																		...
																		<input type="text" name="description_geo" class="form-control" >
																	</div>
						                                        </div>
										...
										<!--english-->
															...
															<div class="row">
					                                        	...
					                                        	<div class="col-md-12">
																	<div class="form-group label-floating">
																		...
																		<input type="text" class="form-control" name="categoryNameEng">
																	</div>
																</div>
											...
											<!--add button-->
		                                    <button type="submit" name="add_category" class="btn btn-primary pull-right" class="alert alert-info alert-with-icon" onclick="demo.showNotification('top','center')">დამატება</button>
                		...
                		var formData = new FormData();
                            ...
                            $.ajax({
                                ...
                                success: function (response){
                                    window.location.replace('category_view.php');
                                },
