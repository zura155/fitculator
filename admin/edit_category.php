...
if(isset($_POST['data_id']))
{
	...
	$des_sql = mysql_query("SELECT * FROM category WHERE id = ".$dataId."");
...
<body>
	...
	<div class="wrapper">
	    ...
	    <div class="main-panel">
			...
			$designers_sql= mysql_query("SELECT * FROM `category` WHERE `id` = ".$designerId."");
								...
								<div class="card-header" data-background-color="purple">
									<div class="nav-tabs-navigation">
										<div class="nav-tabs-wrapper">
											<span class="nav-tabs-title">კატეგორიის რედაქტირება:</span>
						                                    ...
						                                    <div class="row">
						                                        ...
						                                        <div class="col-md-12">
																	<div class="form-group label-floating">
																		<label class="control-label">კატეგორიის სახელი</label>
																		<input type="text" class="form-control" name="categoryNameGeo" value="<?php echo $designers_row["category_name_geo"] ?>">
																	</div>
						                                        </div>
						                                        ...
						                                        <div class="col-md-12">
																	<div class="form-group label-floating">
																		<label class="control-label">კატეგორიის აღწერა</label>
																		<input type="text" class="form-control"  name="description_geo" value="<?php echo $designers_row["description_geo"] ?>">
																	</div>
						                                        </div>
															...
															<div class="row">
						                                        ...
						                                        <div class="col-md-12">
																	<div class="form-group label-floating">
																		...
																		<input type="text" class="form-control"  name="categoryNameEng" value="<?php echo $designers_row["category_name_eng"] ?>">
																	</div>
						                                        </div>
						                                        ...
						                                        <div class="col-md-12">
																	<div class="form-group label-floating">
																		<label class="control-label">Category Area</label>
																		<input type="text" class="form-control" name="description_eng" value="<?php echo $designers_row["description_eng"] ?>">
																	</div>
						                                        </div>
...
<script type="text/javascript">
		...
		$(document).ready(function() {
            $("#images-input").fileinput({
				...
				<?php
					echo "\"<img src='../upload/category/" . $designers_row["photo"] ."' class='file-preview-image' style='width:150px;'>\","
				?>
				],
