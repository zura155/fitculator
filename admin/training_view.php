        ...
        <nav class="navbar navbar-transparent navbar-absolute">
            <div class="container-fluid">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#">ტრენინგები</a>
                </div>
                    ...
                    <div class="col-md-8">
                        <div class="card">
                            <div class="card-header" data-background-color="purple">
                                ...
                                <h4 class="title">ტრენინგები</h4>
                                <p class="category">ჩვენი ყველა ტრენინგი</p>
                            </div>
                            <div class="card-content table-responsive">
                                <table class="table">
                                    <thead class="text-primary">
                                        <th>ტრენინგის ფოტო</th>
                                        <th>ტრენინგის სახელი</th>
                                    </thead>
                                    <tbody>
                                        ...
                                        $stmt = $db->query('SELECT count(id) FROM training');
                                        ...
                                        $data = $db->query('SELECT * FROM training  ORDER BY id DESC '.$pages->get_limit());
                                        ...
                                        <tr>
                                            <td><img src="../upload/trainings/<?php echo $news_row["photo"]; ?>" style="width: 70px; min-height:50px; max-height:50px;"></td>
                                            <td><?php echo $news_row["training_title_geo"]; ?></td>


                                            <td class="td-actions text-right">

                                                <form method="post" action="edit_training.php" class="editDel" >
	 ...
	 <script>
		$(document).ready(function() {
			...
			$("#confirm-submit .btn-success.success").click(function(){
				...
				$.post('', {table_name: 'training', data_id: currentId});
				location.reload();	
			});
