	                    ...
	                    <div class="col-md-8">
	                        <div class="card">
	                            <div class="card-header" data-background-color="purple">
	                                ...
	                                <h4 class="title">რჩევები</h4>
	                                <p class="category">ჩვენი ყველა რჩევა</p>
	                            </div>
	                            <div class="card-content table-responsive">
	                                <table class="table">
	                                    <thead class="text-primary">
	                                    	<th width="120">სურათი</th>
	                                    	<th>რჩევის სათაური</th>
	                                    	<th>რჩევის აღწერა</th>
	                                    </thead>
	                                    <tbody>
										...
										$stmt = $db->query('SELECT count(id) FROM tips');
										...
										$data = $db->query('SELECT * FROM tips ORDER BY id DESC '.$pages->get_limit());
                                        ...
                                        ?>	                                    
	                                        ...
	                                        <tr>
	                                        	<td><img src="../upload/tips/<?php echo $news_row["photo"]; ?>" style="width: 70px; min-height:50px; max-height:50px;"></td>
	                                        	<td><?php echo $news_row["tips_title_geo"]; ?></td>
	                                        	<td><?php echo $news_row["tips_description_short_geo"]; ?></td>

												<td class="td-actions text-right">
													<form  class="editDel" method="post" action="edit_tips.php">
	 ...
	 <script>
		$(document).ready(function() {
			...
			$("#confirm-submit .btn-success.success").click(function(){
				...
				$.post('', {table_name: 'tips', data_id: currentId});
				location.reload();	
			});
