			...
			<nav class="navbar navbar-transparent navbar-absolute">
				<div class="container-fluid">
					...
					<div class="navbar-header">
						...
						<a class="navbar-brand" href="#">სიახლეები</a>
					</div>
	                    ...
	                    <div class="col-md-12">
	                        <div class="card">
	                            <div class="card-header" data-background-color="purple">
	                                <a href="add_news.php">
                                    	<button type="button" class="btn btn-warning" style="float:right; font-size:16px; margin: 6px;"><i class="material-icons" style="font-size:22px;">add_box</i> სიახლის დამატება</button>
	                                	
	                                </a>
                                    <i class="material-icons" style="float: left; font-size: 50px; padding-right: 5px;">description</i>
	                                <h4 class="title">სიახლეები</h4>
	                                <p class="category">სიახლეების რაოდენობა - <?php countResult("news"); ?></p>
	                            </div>
	                            <div class="card-content table-responsive">
	                                <table class="table">
										...
										$data = $db->query('SELECT * FROM news ORDER BY id DESC '.$pages->get_limit());
                                        ...
                                        ?>
	                                        ...
	                                        <tr>
	                                        	<td><img src="../upload/news/<?php echo $news_row["photo"]; ?>" style="width: 70px; min-height:50px; max-height:50px;"></td>
	                                        	<td><?php echo $news_row["news_title_geo"]; ?></td>
	                                        	<td><?php echo $news_row["news_description_short_geo"]; ?></td>

												<td class="td-actions text-right">
													<form  class="editDel" method="post" action="edit_news.php">
                                                	<input type="hidden" name="dataId" value="<?php echo $news_row["id"]; ?>">
	 ...
	 <script>
		$(document).ready(function() {
			...
			$("#confirm-submit .btn-success.success").click(function(){
				...
				$.post('', {table_name: 'news', data_id: currentId});
				location.reload();	
			});
