			...
			<nav class="navbar navbar-transparent navbar-absolute">
				<div class="container-fluid">
					...
					<div class="navbar-header">
						...
						<a class="navbar-brand" href="#">დიზაინი</a>
					</div>
				...
				<div class="container-fluid">
					...
					<div class="col-md-4">
                        <div class="card">
                            ...
                            <div class="card-footer">
                                <div class="stats"><a href="design_category_view.php" class="bluei">დიზაინის კატეგორიები <h3 class="title right"><?php countResult("design_category"); ?></h3> </a></div>
                            </div>
                        </div>
					</div>
					...
					<div class="col-md-4">
                        <div class="card">
                            ...
                            <div class="card-footer">
                                <div class="stats"><a href="designer_view.php" class="redi">დიზაინერების რაოდენობა <h3 class="title right"><?php countResult("designers"); ?></h3> </a></div>
                            </div>
                        </div>
                    </div>
                    ...
                    <canvas id="canvas" style="background-color:#EEEEEE !important"></canvas>
