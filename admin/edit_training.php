<?php session_start(); 
   ...
   if(isset($_POST['data_id']))
   {
   	...
   	$des_sql = mysql_query("SELECT * FROM training WHERE id = ".$dataId."");
      ...
      <form enctype="multipart/form-data"  id="submit-form">
         <div class="wrapper">
            ...
            <div class="main-panel">
               ...
               <?php
                  $treiningId = isset($_POST["treiningId"]) ? $_POST["treiningId"] : '' ;
                  
                  $designers_sql= mysql_query("SELECT * FROM `training` WHERE `id` = ".$treiningId."");
                              ...
                              <div class="card-header" data-background-color="red">
                                 <div class="nav-tabs-navigation">
                                    <div class="nav-tabs-wrapper">
                                       <span class="nav-tabs-title">ტრენინგის რედაქტირება:</span>
                              ...
                              <div class="card-content">
                                 <div class="tab-content">
                                       ...
                                       <div class="row">
                                          <div class="col-md-12">
                                             <div class="form-group label-floating">
                                                ...
                                                <input type="text" class="form-control" name="training_title_geo" value="<?php echo $des_row["training_title_geo"]; ?>">
                                             </div>
                                          </div>
                                          <div class="col-md-12">
                                             <div class="form-group label-floating">
                                                <select class="option_form" name="treinerId">
                                                   <option <?php if($des_row["treinerId"] == 0){ echo 'selected="selec"';} ?>>აირჩიე ტრენერი </option>
                                                   <?php
                                                      $ders_sql = mysql_query("SELECT * FROM trainers ORDER BY id");
                                                      while ($ders_row = mysql_fetch_array($ders_sql))
                                                      {
                                                      ?>
                                                   <option value="<?php echo $ders_row["id"]; ?>" <?php if($des_row["treinerId"] == $ders_row["id"]){ echo 'selected="selec"';} ?>>
                                          ...
                                          <div class="col-md-12">
                                             <div class="form-group label-floating">
                                                ...
                                                <textarea class="form-control textareaa" name="training_description_long_geo"> <?php echo $des_row["training_description_long_geo"]; ?></textarea>
                                             </div>
                                          </div>
                                       </div>
                                    </div>
                                       ...
                                       <div class="row">
                                          <div class="col-md-12">
                                             <div class="form-group label-floating">
                                                ...
                                                <input type="text" class="form-control" name="training_title_eng" value="<?php echo $des_row["training_title_eng"]; ?>">
                                             </div>
                                          </div>
                                          <div class="col-md-12">
                                             <div class="form-group label-floating">
                                                ...
                                                <div style="clear: both; height: 40px;"></div>
                                                <textarea class="form-control textareaa" name="training_description_long_eng"><?php echo $des_row["training_description_long_eng"]; ?></textarea>
                                             </div>
                                          </div>
                                       </div>
                                    </div>
                                    ...
                                    <div class="col-lg-5" style=" border-style: dashed;  border-color: #66bb6a; border-width: 2px; float: right;">
																			...
																			<label class="control-label">Select File <?php echo $des_row["silabus"]; ?></label>
																			<input id="input-1" type="file" class="file" name="classnotes[]" type="file" multiple class="file-loading">
																			
                                    </div>
																	 
                                    <div style="clear: both; height: 20px;"></div>
                                    <input  name="treiningId" type="hidden" value="<?php echo $des_row["id"]; ?>">
                                    <input type="hidden" name="trainigPhoto" value="<?php echo $des_row["photo"] ?>">
                                    <input type="hidden" name="trainigfile" value="<?php echo $des_row["silabus"] ?>">
                                    <!--add button-->
                        ...
                        <div class="col-md-4">
                           <div class="card">
                              ...
                              <div class="card-footer">
                                 <div class="stats">
                                    <a href="training_view.php">
                                       ტრენინგის რაოდენობა 
                                       <h3 class="title right">3</h3>
                                    </a>
                                 </div>
                              </div>
                           </div>
               ...
               <footer class="footer">
                  <div class="container-fluid">
                     ...
                     <p class="copyright pull-right">
                        &copy; <script>document.write(new Date().getFullYear())</script> <a href="webmania.ge">GreenArea</a>,Created By Webmania 
                     </p>
                  </div>
               </footer>
            </div>
...
<script type="text/javascript">
   $(document).ready(function() {
   		...
   		<?php
      echo "\"<img src='../upload/trainings/" . $des_row["photo"] ."' class='file-preview-image' style='width:150px;'>\","
      ?>
   		],
