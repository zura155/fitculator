			...
			<nav class="navbar navbar-transparent navbar-absolute">
				<div class="container-fluid">
					...
					<div class="navbar-header">
						...
						<a class="navbar-brand" href="#">პროდუქცია</a>
					</div>
				...
				<div class="container-fluid">
					...
					<div class="col-md-4">
							<div class="card">
								...
								<div class="card-footer">
									<div class="stats"><a href="category_view.php">კატეგორიების რაოდენობა <h3 class="title right"><?php countResult("category"); ?></h3> </a></div>
								</div>
							</div>
						</div>
					...
					<div class="col-md-4">
                        <div class="card">
                            ...
                            <div class="card-footer">
                                <div class="stats"><a href="#" class="bluei">მაღაზიების რაოდენობა <h3 class="title right">0</h3> </a></div>
                            </div>
                        </div>
                    </div>
