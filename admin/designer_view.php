			...
			<nav class="navbar navbar-transparent navbar-absolute">
				<div class="container-fluid">
					...
					<div class="navbar-header">
						...
						<a class="navbar-brand" href="#">დიზაინერები</a>
					</div>
	                    ...
	                    <div class="col-md-8">
	                        <div class="card">
	                            <div class="card-header" data-background-color="purple">
	                                ...
	                                <h4 class="title">დიზაინერები</h4>
	                                <p class="category">ჩვენი ყველა დიზაინერი</p>
	                            </div>
	                            <div class="card-content table-responsive">
	                                <table class="table">
	                                    <thead class="text-primary">
	                                    	<th width="120">სურათი</th>
	                                    	<th>დიზაინერის სახელი</th>
										...
										$stmt = $db->query('SELECT count(id) FROM designers');
										...
										$data = $db->query('SELECT * FROM designers ORDER BY id DESC '.$pages->get_limit());
                                        ...
                                        ?>
	                                        ...
	                                        <tr>
	                                        	<td><a href="?id=<?php echo $news_row["id"]; ?>"><img src="../upload/designers/<?php echo $news_row["photo"]; ?>" style="width: 70px; min-height:50px; max-height:50px;"></a></td>
												...
												<td class="td-actions text-right">
													<form   method="post" action="edit_designer.php">
	 ...
	 <script>
		$(document).ready(function() {
			...
			$("#confirm-submit .btn-success.success").click(function(){
				...
				$.post('', {table_name: 'designers', data_id: currentId});
				location.reload();	
			});
