...
if(isset($_POST['data_id']))
{
	...
	$des_sql = mysql_query("SELECT * FROM trainers WHERE id = ".$dataId."");
...
<body>
	...
	<div class="wrapper">
	    ...
	    <div class="main-panel">
			...
			$designers_sql= mysql_query("SELECT * FROM `trainers` WHERE `id` = ".$designerId."");
								...
								<div class="card-header" data-background-color="purple">
									<div class="nav-tabs-navigation">
										<div class="nav-tabs-wrapper">
											<span class="nav-tabs-title">ტრენერის რედაქტირება:</span>
...
<script type="text/javascript">
		...
		$(document).ready(function() {
            $("#images-input").fileinput({
				...
				<?php
					echo "\"<img src='../upload/trainers/" . $designers_row["photo"] ."' class='file-preview-image' style='width:150px;'>\","
				?>
				],
