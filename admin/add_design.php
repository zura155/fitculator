								...
								<div class="card-header" data-background-color="red">
									<div class="nav-tabs-navigation">
										<div class="nav-tabs-wrapper">
											<span class="nav-tabs-title">დიზაინის დამატება:</span>
						                                    ...
						                                    <div class="row">
						                                        ...
						                                        <div class="col-md-12">
																	<div class="form-group label-floating">
																		...
																		<input type="text" class="form-control" name="designe_title_geo">
																	</div>
						                                        </div>
						                                        ...
						                                        <div class="col-md-12">
																	<div class="form-group label-floating">
																		...
																		<input type="text" class="form-control" name="designe_description_short_geo">
																	</div>
						                                        </div>
						                                        ...
						                                        <div class="col-md-12">
																	<div class="form-group label-floating">
																		...
																		<input type="number" class="form-control"  name="designe_area">
																	</div>
						                                        </div>
						                                        ...
						                                        <div class="col-md-12">
																	<div class="form-group label-floating">
																		<select class="option_form" name="designerId">
																			<option value="0">აირჩიე დიზაინერი</option>
                                                                            <?php
																	...
																	<div class="form-group label-floating">
																		<select class="option_form" name="descatId">
                                                                            ...
                                                                            <?php
																				...
																				{
																					echo '<option value="'.$descat_row["id"].'">'.$descat_row["category_name_geo"].'</option>';	
																				}
																			?>
																		</select>
																	</div>
						                                        ...
						                                        <div class="col-md-12">
																	<div class="form-group label-floating">
																		...
																		<textarea class="form-control textareaa" name="designe_description_long_geo"></textarea>
																	</div>
						                                        </div>
															...
															<div class="row">
						                                        ...
						                                        <div class="col-md-12">
																	<div class="form-group label-floating">
																		...
																		<input type="text" class="form-control" name="designe_title_eng">
																	</div>
						                                        </div>
						                                        ...
						                                        <div class="col-md-12">
																	<div class="form-group label-floating">
																		...
																		<input type="text" class="form-control" name="designe_description_short_eng">
																	</div>
						                                        </div>
						                                        ...
						                                        <div class="col-md-12">
																	<div class="form-group label-floating">
																		...
																		<div style="clear: both; height: 40px;"></div>
																		<textarea class="form-control textareaa" name="designe_description_long_eng"></textarea>
																	</div>
						                                        </div>
                		...
                		var formData = new FormData();
                            ...
                            $.ajax({
                                ...
                                success: function (response){
                                    window.location.replace('design_view.php');
                                },
