			...
			<nav class="navbar navbar-transparent navbar-absolute">
				<div class="container-fluid">
					...
					<div class="navbar-header">
						...
						<a class="navbar-brand" href="#">მრჩეველები</a>
					</div>
	                    ...
	                    <div class="col-md-8">
	                        <div class="card">
	                            <div class="card-header" data-background-color="purple">
	                                ...
	                                <h4 class="title">მრჩეველები</h4>
	                                <p class="category">ჩვენი ყველა მრჩეველი</p>
	                            </div>
	                            <div class="card-content table-responsive">
	                                <table class="table">
	                                    <thead class="text-primary">
	                                    	<th width="120">სურათი</th>
	                                    	<th>მრჩეველის სახელი</th>
	                                    </thead>
	                                    <tbody>
										...
										$stmt = $db->query('SELECT count(id) FROM advisor');
										...
										$data = $db->query('SELECT * FROM advisor ORDER BY id DESC '.$pages->get_limit());
                                        ...
                                        ?>
	                                        ...
	                                        <tr>
	                                        	<td><img src="../upload/advisor/<?php echo $news_row["photo"]; ?>" style="width: 70px; min-height:50px; max-height:50px;"></td>
	                                        	<td><?php echo $news_row["name_geo"]; ?></td>


												<td class="td-actions text-right">
													<form  class="editDel" method="post" action="edit_advisor.php">
                                                    ...
                                                    <form class="editDel" method="post" id="submit-form">
	 ...
	 <script>
		$(document).ready(function() {
			...
			$("#confirm-submit .btn-success.success").click(function(){
				...
				$.post('', {table_name: 'advisor', data_id: currentId});
				location.reload();	
			});
