								...
								<div class="card-header" data-background-color="purple">
									<div class="nav-tabs-navigation">
										<div class="nav-tabs-wrapper">
											<span class="nav-tabs-title">რჩევის დამატება</span>
								...
								<form enctype="multipart/form-data"  id="submit-form">
									...
									<div class="card-content">
						                                    ...
						                                    <div class="row">
						                                        ...
						                                        <div class="col-md-12">
																	<div class="form-group label-floating">
																		<label class="control-label">რჩევის სათაური</label>
																		<input type="text" name="tips_title_geo" class="form-control" >
																	</div>
						                                        </div>
						                                        ...
						                                        <div class="col-md-12">
																	<div class="form-group label-floating">
																		<select class="option_form" name="advisorId">
																			<option value="0">აირჩიე მრჩეველი</option>
                                                                            <?php
						                                        ...
						                                        <div class="col-md-12">
																	<div class="form-group label-floating">
																		...
																		<textarea class="form-control textareaa"  name="tips_description_short_geo"></textarea>
																	</div>
						                                        </div>
						                                        ...
						                                        <div class="col-md-12">
																	<div class="form-group label-floating">
																		...
																		<div style="clear: both; height: 40px;"></div>
																		<textarea class="form-control textareaa"  name="tips_description_long_geo"></textarea>
																	</div>
						                                        </div>
										...
										<!--english-->
															...
															<div class="row">
					                                        	...
					                                        	<div class="col-md-12">
																	<div class="form-group label-floating">
																		...
																		<input type="text" class="form-control" name="tips_title_eng">
																	</div>
																</div>
					                                        	...
					                                        	<div class="col-md-12">
																	<div class="form-group label-floating">
																		...
																		<input type="text" class="form-control" name="tips_description_short_eng">
																	</div>
																</div>
						                                        ...
						                                        <div class="col-md-12">
																	<div class="form-group label-floating">
																		...
																		<div style="clear: both; height: 40px;"></div>
																		<textarea class="form-control textareaa" name="tips_description_long_eng"></textarea>
																	</div>
						                                        </div>
                                                    ...
                                                    <input type="hidden" name="add_tips">
											...
											<!--add button-->
		                                    <button type="submit" name="add_tips" class="btn btn-primary pull-right" class="alert alert-info alert-with-icon" onclick="demo.showNotification('top','center')">დამატება</button>
                		...
                		var formData = new FormData();
                            ...
                            $.ajax({
                                ...
                                success: function (response){
                                    window.location.replace('tips_view.php');
                                },
