								...
								<div class="card-header" data-background-color="purple">
									<div class="nav-tabs-navigation">
										<div class="nav-tabs-wrapper">
											<span class="nav-tabs-title">დიზაინერის დამატება:</span>
								...
								<form enctype="multipart/form-data"  id="submit-form">
									...
									<div class="card-content">
										...
										<!--english-->
                                                    ...
                                                    <input type="hidden" name="add_designer">
											...
											<!--add button-->
		                                    <button type="submit" name="add_designer" class="btn btn-primary pull-right" class="alert alert-info alert-with-icon" onclick="demo.showNotification('top','center')">დამატება</button>
                		...
                		var formData = new FormData();
                            ...
                            $.ajax({
                                ...
                                success: function (response){
                                    window.location.replace('designer_view.php');
                                },
