			...
			<nav class="navbar navbar-transparent navbar-absolute">
				<div class="container-fluid">
					...
					<div class="navbar-header">
						...
						<a class="navbar-brand" href="trainer_view.php">ტრენერები</a>
					</div>
								...
								<div class="card-header" data-background-color="purple">
									<div class="nav-tabs-navigation">
										<div class="nav-tabs-wrapper">
											<span class="nav-tabs-title">ტრენერის დამატება:</span>
								...
								<form enctype="multipart/form-data"  id="submit-form">
									...
									<div class="card-content">
						                                    ...
						                                    <div class="row">
						                                        ...
						                                        <div class="col-md-12">
																	<div class="form-group label-floating">
																		<label class="control-label">ტრენერის სახელი</label>
										...
										<!--english-->
                                                    ...
                                                    <input type="hidden" name="add_trainer">
											...
											<!--add button-->
		                                    <button type="submit" name="add_trainer" class="btn btn-primary pull-right" class="alert alert-info alert-with-icon" onclick="demo.showNotification('top','center')">დამატება</button>
					...
					<div class="col-md-4">
							<div class="card">
								...
								<div class="card-footer">
									<div class="stats"><a href="training_view.php">ტრენნინგების რაოდენობა <h3 class="title right">3</h3> </a></div>
								</div>
							</div>
                		...
                		var formData = new FormData();
                            ...
                            $.ajax({
                                ...
                                success: function (response){
                                    window.location.replace('trainer_view.php');
                                },
