								...
								<div class="card-header" data-background-color="purple">
									<div class="nav-tabs-navigation">
										<div class="nav-tabs-wrapper">
											<span class="nav-tabs-title">სერვისის დამატება</span>
								...
								<form enctype="multipart/form-data"  id="submit-form">
									...
									<div class="card-content">
						                                    ...
						                                    <div class="row">
						                                        ...
						                                        <div class="col-md-12">
																	<div class="form-group label-floating">
																		...
																		<input type="text" name="service_title_geo" class="form-control" >
																	</div>
						                                        </div>
						                                        ...
						                                        <div class="col-md-12">
																	<div class="form-group label-floating">
																		...
																		<input type="text"  name="service_description_short_geo" class="form-control" >
																	</div>
						                                        </div>
						                                        ...
						                                        <div class="col-md-12">
																	<div class="form-group label-floating">
																		...
																		<textarea class="form-control textareaa"  name="service_description_long_geo"></textarea>
																	</div>
						                                        </div>
										...
										<!--english-->
															...
															<div class="row">
					                                        	...
					                                        	<div class="col-md-12">
																	<div class="form-group label-floating">
																		...
																		<input type="text" class="form-control" name="service_title_eng">
																	</div>
																</div>
					                                        	...
					                                        	<div class="col-md-12">
																	<div class="form-group label-floating">
																		...
																		<input type="text" class="form-control" name="service_description_short_eng">
																	</div>
																</div>
						                                        ...
						                                        <div class="col-md-12">
																	<div class="form-group label-floating">
																		...
																		<div style="clear: both; height: 40px;"></div>
																		<textarea class="form-control textareaa" name="service_description_long_eng"></textarea>
																	</div>
						                                        </div>
											...
											<!--add button-->
		                                    <button type="submit" name="add_service" class="btn btn-primary pull-right" class="alert alert-info alert-with-icon" onclick="demo.showNotification('top','center')">დამატება</button>
