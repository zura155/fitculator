...
grd.addColorStop(1,cb(rand(238,238),rand(238,238),rand(238,238),25));

//flowers!
var num_flowers = 7;
var fs = [];
for (var i = 0; i < num_flowers; i++){
    fs.push({size:rand(1,5),petals:rand(4,12),rot:rand(-5,5),c:[rand(100,255),rand(100,255),rand(100,255)],x:w/2,y:h/2});
}
