...
{
	$dataId = $_POST['catId'];
	$des_sql = mysql_query("SELECT * FROM design_category WHERE id = ".$dataId."");
...
<body>
	...
	<div class="wrapper">
	    ...
	    <div class="main-panel">
			<nav class="navbar navbar-transparent navbar-absolute">
				<div class="container-fluid">
					...
					<div class="navbar-header">
						...
						<a class="navbar-brand" href="design_category_view.php">კატეგორიები</a>
					</div>
			...
			$designerId = isset($_POST["catId"]) ? $_POST["catId"] : '' ;

			$designers_sql= mysql_query("SELECT * FROM `design_category` WHERE `id` = ".$designerId."");
								...
								<form enctype="multipart/form-data"  id="submit-form" method="post">
									...
									<div class="card-content">
										...
										<!--english-->
											...
											<!--add button-->
		                                    <button type="submit" name="edit_design_category" class="btn btn-primary pull-right" class="alert alert-info alert-with-icon" onclick="demo.showNotification('top','center')">რედაქტირება</button>
...
$("#submit-form").submit(function(e) {
                		...
                		var formData = new FormData();
                            ...
                            $imageInput.val("");
                            $.ajax({
                                url: "block/edit_design_category.php",
                                type: "POST",
                                datatype: "json",
                                data: formData,
