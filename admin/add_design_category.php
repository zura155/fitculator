			...
			<nav class="navbar navbar-transparent navbar-absolute">
				<div class="container-fluid">
					...
					<div class="navbar-header">
						...
						<a class="navbar-brand" href="design_category_view.php">დიზაინის კატეგორიები</a>
					</div>
	        ...
	        <div class="content">
	            <div class="container-fluid">
	                <div class="row">
	                   ...
	                   <div class="col-md-8">
							<div class="card card-nav-tabs" style="min-height:457px;">
								...
								<form enctype="multipart/form-data"  id="submit-form">
									...
									<div class="card-content">
										...
										<!--english-->
											...
											<!--add button-->
		                                    <button type="submit" name="add_design_category" class="btn btn-primary pull-right" class="alert alert-info alert-with-icon" onclick="demo.showNotification('top','center')">დამატება</button>
...
$("#submit-form").submit(function(e) {
                		...
                		var formData = new FormData();
                            ...
                            $imageInput.val("");
                            $.ajax({
                                url: "block/add_design_category.php",
                                type: "POST",
                                datatype: "json",
                                data: formData,
                                ...
                                success: function (response){
                                    window.location.replace('design_category_view.php');
                                },
