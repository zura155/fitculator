...
if(isset($_POST['data_id']))
{
	...
	$des_sql = mysql_query("SELECT * FROM service WHERE id = ".$dataId."");
...
<body>
	...
	<div class="wrapper">
	    ...
	    <div class="main-panel">
			<nav class="navbar navbar-transparent navbar-absolute">
				<div class="container-fluid">
					...
					<div class="navbar-header">
						...
						<a class="navbar-brand" href="service.php">სერვისი</a>
					</div>
			...
			$designers_sql= mysql_query("SELECT * FROM `service` WHERE `id` = ".$designerId."");
								...
								<div class="card-header" data-background-color="purple">
									<div class="nav-tabs-navigation">
										<div class="nav-tabs-wrapper">
											<span class="nav-tabs-title">სერვისის რედაქტირება:</span>
													...
													<div class="tab-pane active" id="profile">
						                                    <div class="row">
						                                        ...
						                                        <div class="col-md-12">
																	<div class="form-group label-floating">
																		<label class="control-label">სერვისის სახელი</label>
																		<input type="text" class="form-control" name="service_title_geo" value="<?php echo $designers_row["service_title_geo"] ?>">
																	</div>
						                                        </div>
						                                        ...
						                                        <div class="col-md-12">
																	<div class="form-group label-floating">
																		...
																		<input type="text" class="form-control"  name="service_description_short_geo" value="<?php echo $designers_row["service_description_short_geo"] ?>">
																	</div>
						                                        </div>
                                                            ...
                                                            <div class="col-md-12">
                                                                <div class="form-group label-floating">
                                                                    ...
                                                                    <textarea class="form-control textareaa" name="service_description_long_geo"> <?php echo $designers_row["service_description_long_geo"]; ?></textarea>
                                                                </div>
                                                            </div>
													...
													<div class="tab-pane" id="messages">
															<div class="row">
						                                        ...
						                                        <div class="col-md-12">
																	<div class="form-group label-floating">
																		...
																		<input type="text" class="form-control"  name="service_title_eng" value="<?php echo $designers_row["service_title_eng"] ?>">
																	</div>
						                                        </div>
						                                        ...
						                                        <div class="col-md-12">
																	<div class="form-group label-floating">
																		...
																		<input type="text" class="form-control" name="service_description_short_eng" value="<?php echo $designers_row["service_description_short_eng"] ?>">
																	</div>
						                                        </div>
                                                            ...
                                                            <div class="col-md-12">
                                                                <div class="form-group label-floating">
                                                                    ...
                                                                    <div style="clear: both; height: 40px;"></div>
                                                                    <textarea class="form-control textareaa" name="service_description_long_eng"> <?php echo $designers_row["service_description_long_eng"]; ?></textarea>
                                                                </div>
                                                            </div>
						...
						<div class="col-md-4">
							...
							<div class="card">
								<div class="card-header card-chart" data-background-color="green">
                                	<h4 class="title">	
                                        <a href="add_service.php" class="inlineAdd">
								...
								<div class="card-footer">
									<div class="stats"><a href="service.php">სერვისების რაოდენობა <h3 class="title right">5</h3> </a></div>
								</div>
							</div>
...
<script type="text/javascript">
		...
		$(document).ready(function() {
            $("#images-input").fileinput({
				...
				<?php
					echo "\"<img src='../upload/service/" . $designers_row["photo"] ."' class='file-preview-image' style='width:150px;'>\","
				?>
				],
