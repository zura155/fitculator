...
if (!isset($_SESSION['username']) || $_SESSION['username'] == '' || $num_rows != 1){
	...
	if (isset($_FILES["images"]))
		...
		$sql="INSERT INTO `trainers` (`id`, `name_geo`, `name_eng`, `fb_link`, `in_link`, `photo`) VALUES (NULL, '".mysql_real_escape_string($name_geo)."', '".mysql_real_escape_string($name_eng)."', '".mysql_real_escape_string($fb_link)."', '".mysql_real_escape_string($in_link)."', '".mysql_real_escape_string($logo_name)."')";
