...
class Paginator{
	...
	*/
	...
	public function page_links($path='?',$ext=null)
	{
		...
		if ($this->_page > 1)
		    $pagination.= "<li><a href='".$path."$this->_instance=$prev"."$ext'>უკან</a></li>";
		else
		    $pagination.= "<span class='disabled'>უკან</span>";   
		...
		if ($counter == $this->_page)
		    ...
		    $pagination.= "<li><a href='#' onclick='goToPage($counter)'>$counter</a></li>";                   
		}
		}
		...
		if ($this->_page < $counter - 1)
		    $pagination.= "<li><a href='".$path."$this->_instance=$next"."$ext'>შემდეგი</a></li>";
		else
		    $pagination.= "<li><span class='disabled'>შემდეგი</span></li>";
		    $pagination.= "</ul>\n";       
		}
