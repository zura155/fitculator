...
<body class="steps-page">
    ...
    <main>
        ...
        <section class="main container">
            ...
            <div class="main__step active" data-step="23%" id="protein">
                ...
                <div class="main__test multi-svg-choose">
                    <div data-multi-choose="check">
                        ...
                        </svg><span data-answer="chicken"><?php echo CHICKEN; ?></span>
                    </div>
                    <div data-multi-choose="check">
                        <svg>
                    ...
                    <div data-multi-choose="check">
                        ...
                        </svg><span data-answer="turkey"><?php echo TURKEY; ?></span>
                    </div>
                    <div data-multi-choose="check">
                        <svg>
                            <use xlink:href="themes/fitculator/img/sprite.svg#_icon_set-05"></use>
                        </svg><span data-answer="pork"><?php echo PORK; ?></span>
                    </div>
            ...
            <div class="main__step" data-step="37%" id="veggies">
                <div class="question__help">
                    <svg>
                        <use xlink:href="themes/fitculator/img/sprite.svg#_icon_set-44"></use>
                    </svg>
                ...
                <div class="main__test multi-svg-choose">
                    ...
                    <div data-multi-choose="check">
                        ...
                        </svg><span data-answer="zucchini"><?php echo ZUCCHINI; ?></span>
                    </div>
                    <div data-multi-choose="check">
                        <svg>
                            <use xlink:href="themes/fitculator/img/sprite.svg#_icon_-04"></use>
                        </svg><span data-answer="cauliflower"><?php echo CAULIFLOWER; ?></span>
                    </div>
                    <div data-multi-choose="check">
                        <svg>
                            <use xlink:href="themes/fitculator/img/sprite.svg#_icon_-06"></use>
                        </svg><span data-answer="avocados"><?php echo AVOCADOS; ?></span>
                    </div>
                    <p class="test-multi-svg-answer next-question"> <?php echo CONTI; ?></p>
                </div>
            </div>
            <div class="main__step" data-step="63%" id="products">
                <div class="question__help">
                    <svg>
                        <use xlink:href="themes/fitculator/img/sprite.svg#_icon_set-44"></use>
                    </svg>
                ...
                <div class="main__header">
                    <!--p.main__header-action Please click to include <br>products you like-->
                    <div class="h1"><b><?php echo DAIRY_PLANT; ?></b></div>
                    <p class="main__header-action"><?php echo WICH_PRODUCT; ?></p>
                    <svg class="main__icon">
                ...
                <div class="main__test multi-svg-choose">
                    ...
                    <div data-multi-choose="check">
                        ...
                        </svg><span data-answer="yogurt"><?php echo YOGURT; ?></span>
                    </div>
                    <div data-multi-choose="check">
                        <svg>
                            <use xlink:href="themes/fitculator/img/sprite.svg#_icon_set-21"></use>
                        </svg><span data-answer="soy_milk"><?php echo SOY_MILK; ?></span>
                    </div>
                    <div data-multi-choose="check">
                        <svg>
                    ...
                    <div data-multi-choose="check">
                        ...
                        </svg><span data-answer="tofu"><?php echo TOFU; ?></span>
                    </div>
                    <div data-multi-choose="check">
                        <svg>
                            <use xlink:href="themes/fitculator/img/sprite.svg#_icon_set-25"></use>
                        </svg><span data-answer="tempeh"><?php echo TEMPEH; ?></span>
                    </div>
                    <div data-multi-choose="check">
                        <svg>
                            <use xlink:href="themes/fitculator/img/sprite.svg#_icon_set-26"></use>
                        </svg><span data-answer="cottage_cheese"><?php echo COTTAGE_CHEESE; ?></span>
                    </div>
                    <p class="test-multi-svg-answer next-question"> <?php echo CONTI; ?></p>
                </div>
            </div>
            <div class="main__step" data-step="75%" id="activity">
                <div class="question__help">
                    <svg>
                        <use xlink:href="themes/fitculator/img/sprite.svg#_icon_set-44"></use>
                    </svg>
                ...
                <div class="question__help-window theme">
                    ...
                    <div class="answer"><?php echo PHYSICAL_ACTIVITY_ANSWER; ?></div>
                </div>
                <div class="main__header">
                    <!--p.main__header-action What is your regular level of physical activity?-->
                    <div class="h1"><b><?php echo PHISICAL_ACTIVITY; ?></b></div>
                    <p class="main__header-action"><?php echo PHYS_QUESTION; ?></p>
                    <svg class="main__icon">
                        <use xlink:href="themes/fitculator/img/sprite.svg#_icon_set-27"></use>
                    </svg>
                    <div class="mob-helper"><?php echo SELECT_ONE; ?></div>
                    <!--p.main__header-action What is your regular level of physical activity?-->
                </div>
                <div class="main__test one-choose">
                    <p class="test-answer next-question" data-active="1.2"><?php echo PHYS_ANSWER1; ?></p>
                    <p class="test-answer next-question" data-active="1.375"><?php echo PHYS_ANSWER2; ?></p>
                    <p class="test-answer next-question" data-active="1.4625"><?php echo PHYS_ANSWER3; ?></p>
                    <p class="test-answer next-question" data-active="1.6"><?php echo PHYS_ANSWER4; ?></p>
                    <p class="test-answer next-question" data-active="1.725"><?php echo PHYS_ANSWER5; ?></p>
                </div>
            </div>
            <div class="main__step" data-step="88%" id="lifestyle">
                <div class="question__help">
                    <svg>
                        <use xlink:href="themes/fitculator/img/sprite.svg#_icon_set-44"></use>
                    </svg>
                ...
                <div class="question__help-window theme">
                    ...
                    <div class="answer"><?php echo TYPICAL_ANSWER; ?></div>
                </div>
                <div class="main__header">
                    <!--p.main__header-action select-->
                    <div class="h1"><b><?php echo TYPICAL_DAY; ?></b></div>
                    <p class="main__header-action"><?php echo DESCRIBE_A_TYP_DAY; ?></p>
                    <svg class="main__icon">
                        <use xlink:href="themes/fitculator/img/sprite.svg#_icon_set-33"></use>
                    </svg>
                    <div class="mob-helper"><?php echo SELECT_ONE; ?></div>
                </div>
                <div class="main__test one-choose">
                    <p class="test-answer next-question" data-answer="1"><?php echo AT_THE_OFFICE; ?></p>
                    <p class="test-answer next-question" data-answer="2"><?php echo AT_THE_OFFICE_BUT; ?></p>
                    <p class="test-answer next-question" data-answer="3"><?php echo I_SPEND_BETTER; ?></p>
                    <p class="test-answer next-question" data-answer="4"><?php echo MANUAL_LABOR; ?></p>
                    <p class="test-answer next-question" data-answer="5"><?php echo I_MOSTLY; ?></p>
                </div>
            </div>
        ...
        <section class="steps container theme">
            <div class="steps_allsteps">
                ...
                <a class="step" href="javascript:void(0)"><?php echo DAIRY_PLANT_BASED_PROTAIN; ?></a>
                <a class="step" href="javascript:void(0)"><?php echo PHYSICAL_ACTIVITY; ?></a>
                <a class="step" href="javascript:void(0)"><?php echo LIFESTYLE; ?></a>
